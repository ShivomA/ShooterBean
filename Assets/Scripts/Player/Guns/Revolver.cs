...
public class Revolver : MonoBehaviour
{
    ...
    float reloadingTime = 2f, recoilDuration = 0.4f;
    bool isReloading = false, canFire = true;
    int bulletCount, maxBullet = 9, muzzleVelocity = 250;
    int damage = 40, criticalDamage = 90;

    float xSpread = 0.0015f, ySpread = 0.004f, zSpread = 0, gunAngle = 0;
    float spreadAngleX = 0, spreadAngleY = 0, spreadAngleZ = 0;
    float recoilAngle = -15, recoilStep = -1.5f, maxRecoil = 60;
    int recoilDelay = 20;
