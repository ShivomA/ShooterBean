...
public class Pistol : MonoBehaviour
{
    ...
    float reloadingTime = 1.5f, recoilDuration = 0.3f;
    bool isReloading = false, canFire = true;
    int bulletCount, maxBullet = 9, muzzleVelocity = 200;
    int damage = 30, criticalDamage = 50;

    float xSpread = 0.001f, ySpread = 0.0025f, zSpread = 0, gunAngle = 0;
