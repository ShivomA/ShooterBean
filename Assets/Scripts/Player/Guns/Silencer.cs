...
public class Silencer : MonoBehaviour
{
    ...
    float reloadingTime = 1.75f, recoilDuration = 0.3f;
    bool isReloading = false, canFire = true;
    int bulletCount, maxBullet = 9, muzzleVelocity = 175;
    int damage = 20, criticalDamage = 40;

    float xSpread = 0.0008f, ySpread = 0.02f, zSpread = 0, gunAngle = 0;
    float spreadAngleX = 0, spreadAngleY = 0, spreadAngleZ = 0;
    float recoilAngle = -7.5f, recoilStep = -0.75f, maxRecoil = 35;
    int recoilDelay = 20;
